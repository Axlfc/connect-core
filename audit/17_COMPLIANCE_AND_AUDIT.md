...
1.  **Para CPL-01 (Implementar el Contrato):**
    *   **Solución:** La solución es simple en concepto pero requiere un esfuerzo significativo: **ejecutar el plan definido en el roadmap**.
...
3.  **Integrar el Contrato en el Flujo de Trabajo:**
    *   **Solución:** Modificar la plantilla de Pull Requests (`.github/PULL_REQUEST_TEMPLATE.md`) para incluir una sección que pregunte al contribuidor cómo sus cambios se relacionan con el `DESIGN_TRUTH_CONTRACT.md`.
        ```markdown
