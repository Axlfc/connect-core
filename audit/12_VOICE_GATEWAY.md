...
1.  **Para VG-01 (Validar Tamaño de Subida - CRÍTICO):**
    *   **Solución:** Modificar el endpoint `create_transcription` para validar el tamaño del archivo antes de leerlo en memoria.
        ```python
...
2.  **Para VG-02 (Restringir CORS):**
    *   **Solución:** Modificar la configuración de CORS en `main.py` para que solo permita los dominios de las aplicaciones frontend que necesitan acceder al gateway.
        ```python
        # En main.py
