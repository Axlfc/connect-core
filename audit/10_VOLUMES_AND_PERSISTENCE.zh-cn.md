...
| :--- | :--- | :--- |
| ✓ | **Estrategia de 持久性** | La estrategia de utilizar volúmenes nombrados de Docker para todos los datos de estado (`postgres_storage`, `n8n_storage`, etc.) es **correcta y robusta**. Separa el ciclo de vida de los datos del de los contenedores. |
...
1.  **Para V-01 (Automatizar la Configuración de Duplicati):**
    *   **解决方案:** Crear un script de inicialización para Duplicati.
...
2.  **Para V-02 (Crear un Plan de Recuperación):**
    *   **解决方案:** Crear un documento `DISASTER_RECOVERY.md`.
...
3.  **Para V-03 (Solucionar Permisos):**
    *   **解决方案:** Expandir y hacer cumplir el uso de `setup-permissions.sh`.
