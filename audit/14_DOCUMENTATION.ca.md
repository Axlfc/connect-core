...
3.  **Documentación de Contribució:**
...
4.  **Soporte Multi-Arquitectura Documentado:**
...
1.  **Precisión de la Tabla de Serveis:**
...
1.  **Para DOC-01 (Corregir Afirmaciones de Seguridad):**
    *   **Solució Inmediata:** Modificar el `README.md` para reflejar el estado real del proyecto.
