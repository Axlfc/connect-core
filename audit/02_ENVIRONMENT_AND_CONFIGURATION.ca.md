...
2.  **Para C-03 (Visualización de Secretos):**
    *   **Solució:** Modificar `init_env.sh` para no mostrar el valor generado en la consola. Simplemente informar al usuario que se ha generado y guardado un valor.
        ```diff
        --- a/init_env.sh
        +++ b/init_env.sh
        @@ -145,7 +145,7 @@
