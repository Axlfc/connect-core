...
[![es](https://img.shields.io/badge/lang-es-yellow.svg)](https://github.com/Axlfc/cognito-stack/blob/master/audit/13_DEPENDENCIES_AND_LIBRARIES.md)
[![en](https://img.shields.io/badge/lang-en-red.svg)](https://github.com/Axlfc/cognito-stack/blob/master/audit/13_DEPENDENCIES_AND_LIBRARIES.en.md)
[![ca](https://img.shields.io/badge/lang-ca-blue.svg)](https://github.com/Axlfc/cognito-stack/blob/master/audit/13_DEPENDENCIES_AND_LIBRARIES.ca.md)
[![zh-cn](https://img.shields.io/badge/lang-zh--cn-red.svg)](https://github.com/Axlfc/cognito-stack/blob/master/audit/13_DEPENDENCIES_AND_LIBRARIES.zh-cn.md)
...
| :--- | :--- | :--- |
| ✓ | **Uso de Herramientas Estándar** | El proyecto utiliza manejadores de paquetes estándar de la industria (`pip` para Python, `npm`/`pnpm` para Node.js), lo que facilita la gestión y auditoría de las dependencias. |
...
| ⚠️ | **Uso de Dependencias "Nightly"** | El `Dockerfile.comfyui` instala versiones "nightly" de PyTorch. Estas versiones son inestables por definición, no están pensadas para producción, y pueden contener bugs o vulnerabilidades no descubiertas. |
...
1.  **Para DEP-01 (Fijar Versiones en `requirements.txt` - CRÍTICO):**
    *   **Solución:** Utilizar una herramienta como `pip-tools` para gestionar las dependencias de Python de forma robusta.
...
3.  **Para DEP-03 (Eliminar Dependencias "Nightly"):**
    *   **Solución:** Modificar `Dockerfile.comfyui` para que utilice la última **versión estable** de PyTorch que sea compatible con el hardware de destino.
        ```diff
...
4.  **Implementar Escaneo de Vulnerabilidades:**
    *   **Solución:** Integrar herramientas de escaneo en el proceso de CI/CD.
