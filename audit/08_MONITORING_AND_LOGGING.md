...
1.  **Para M-01 (Implementar Alertas):**
    *   **Solución:** Integrar `Alertmanager` en el stack de monitoreo.
...
2.  **Para M-02 (Centralizar Logs):**
    *   **Solución:** Añadir `Loki` y `Promtail` al stack para la agregación de logs.
...
3.  **Para M-03 (Mejorar la Visibilidad):**
    *   **Solución:** Añadir dashboards estándar de la comunidad para `node-exporter` y `cadvisor`.
