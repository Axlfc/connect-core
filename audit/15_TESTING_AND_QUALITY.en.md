...
[![en](https://img.shields.io/badge/lang-en-red.svg)](https://github.com/Axlfc/cognito-stack/blob/master/audit/15_TESTING_AND_QUALITY.en.md)
[![es](https://img.shields.io/badge/lang-es-yellow.svg)](https://github.com/Axlfc/cognito-stack/blob/master/audit/15_TESTING_AND_QUALITY.md)
[![ca](https://img.shields.io/badge/lang-ca-blue.svg)](https://github.com/Axlfc/cognito-stack/blob/master/audit/15_TESTING_AND_QUALITY.ca.md)
[![zh-cn](https://img.shields.io/badge/lang-zh--cn-red.svg)](https://github.com/Axlfc/cognito-stack/blob/master/audit/15_TESTING_AND_QUALITY.zh-cn.md)
...
1.  **Para T-01 y T-03 (Implementar una Estrategia de Testing Real):**
    *   **Solution:** Adoptar un framework de testing estándar como `pytest` para el código Python.
...
2.  **Para T-02 (Hacer Cumplir la Calidad en CI):**
    *   **Solution:** Eliminar `continue-on-error: true` de todos los pasos de linting en `.github/workflows/validate.yml`.
        ```diff
...
3.  **Integrar Tests en el Pipeline de CI:**
    *   **Solution:** Añadir un nuevo "job" al `validate.yml` o crear un nuevo workflow (`test.yml`) que ejecute las pruebas de `pytest`.
        ```yaml
