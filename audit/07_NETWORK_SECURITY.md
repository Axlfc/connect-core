...
[![es](https://img.shields.io/badge/lang-es-yellow.svg)](https://github.com/Axlfc/cognito-stack/blob/master/audit/07_NETWORK_SECURITY.md)
[![en](https://img.shields.io/badge/lang-en-red.svg)](https://github.com/Axlfc/cognito-stack/blob/master/audit/07_NETWORK_SECURITY.en.md)
[![ca](https://img.shields.io/badge/lang-ca-blue.svg)](https://github.com/Axlfc/cognito-stack/blob/master/audit/07_NETWORK_SECURITY.ca.md)
[![zh-cn](https://img.shields.io/badge/lang-zh--cn-red.svg)](https://github.com/Axlfc/cognito-stack/blob/master/audit/07_NETWORK_SECURITY.zh-cn.md)
...
1.  **Aislamiento de Servicios por Red:**
...
1.  **Para N-01 y N-02 (Rediseñar la Estrategia de `fail2ban`):**
    *   **Solución Ideal (Recomendada):** Eliminar el contenedor de `fail2ban`. Instalar y configurar `fail2ban` **directamente en el sistema operativo del host**. Esto le da acceso legítimo y seguro a los logs y a las `iptables` del host sin romper el modelo de seguridad de Docker.
    *   **Solución Alternativa (Si debe ser en contenedor):**
...
3.  **Para N-04 (Control de Egress):**
    *   **Solución:** Crear una red de Docker dedicada para el acceso a internet y adjuntar solo a los contenedores que lo necesiten explícitamente.
