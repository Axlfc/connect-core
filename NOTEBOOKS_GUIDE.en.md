...
**Purpose:** Pruebas del enrutador de agentes y orquestación multi-agente
...
**Purpose:** Pruebas de comunicación entre n8n y servicios (Ollama, Qdrant)
...
**Purpose:** Pruebas de descomposición de tareas y ejecución paralela
...
**Purpose:** Prueba completa de flujo de trabajo con integración Ollama + Qdrant
...
**Version de cognito-stack:** Latest
